...
public class PatchOperation {
   ...
   * @return op
  **/
  @Schema(required = true, description = "Type of JSON Patch operation. Supported JSON Patch operations include add, replace, and delete. Refer to [JavaScript Object Notation (JSON) Patch](https://tools.ietf.org/html/rfc6902) for more information.")
  public OpEnum getOp() {
    return op;
  }
   ...
   * @return path
  **/
  @Schema(required = true, description = "JSON Pointer path of the element to patch. Refer to [JavaScript Object Notation (JSON) Patch](https://tools.ietf.org/html/rfc6902) for more information.")
