...
import com.amazon.SellingPartnerAPI.models.vendor.df.orders.Error;
...
public class ErrorList {
   ...
   * @return errors
  **/
  @Schema(required = true, description = "An array of Error objects representing individual errors encountered during the request.")
