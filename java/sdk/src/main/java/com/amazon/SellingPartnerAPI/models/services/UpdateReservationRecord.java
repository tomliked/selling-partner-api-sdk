...
import com.amazon.SellingPartnerAPI.models.services.Reservation;
import com.amazon.SellingPartnerAPI.models.services.WarningList;
 ...
 */
@Schema(description = "`UpdateReservationRecord` entity contains the `Reservation` if there is an error/warning while performing the requested operation on it, otherwise it will contain the new `reservationId`.")
