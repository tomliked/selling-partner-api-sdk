...
import com.amazon.SellingPartnerAPI.models.merchantfulfillment.v0.FileType;
...
public class FileContents {
  ...
  **/
   ...
   * @return checksum
  **/
  @Schema(required = true, description = "An MD5 hash to validate the PDF document data, in the form of a Base64 string.")
