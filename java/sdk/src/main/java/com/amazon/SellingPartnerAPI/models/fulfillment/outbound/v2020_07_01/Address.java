...
public class Address {
  ...
  **/
   ...
   * @return city
  **/
  @Schema(description = "The city where the person, business, or institution is located. This property is required in all countries except Japan. It should not be used in Japan.")
