...
import com.amazon.SellingPartnerAPI.ItemBrowseClassification;
 ...
 */
@Schema(description = "Classifications (browse nodes) associated with the item in the Amazon catalog for the indicated Amazon marketplace.")
