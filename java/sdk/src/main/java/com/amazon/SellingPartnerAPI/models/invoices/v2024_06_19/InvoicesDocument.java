 ...
 */
@Schema(description = "An object that contains the `documentId` and an S3 pre-signed URL that you can use to download the specified file.")
...
public class InvoicesDocument {
  ...
  **/
  @Schema(description = "A pre-signed URL that you can use to download the invoices document in zip format. This URL expires after 30 seconds.")
