...
import com.amazon.SellingPartnerAPI.models.orders.RejectionReason;
import com.amazon.SellingPartnerAPI.models.orders.ValidVerificationDetail;
import com.amazon.SellingPartnerAPI.models.orders.VerificationStatus;
...
public class RegulatedOrderVerificationStatus {
  ...
  **/
  @Schema(required = true, description = "When true, the regulated information provided in the order requires a review by the merchant.")
  ...
  **/
   ...
   * @return reviewDate
  **/
  @Schema(description = "The date the order was reviewed. In [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date time format.")
  ...
  **/
  @Schema(description = "A list of valid verification details that may be provided and the criteria required for when the verification detail can be provided.")
