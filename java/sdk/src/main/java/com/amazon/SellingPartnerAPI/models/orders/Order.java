...
import com.amazon.SellingPartnerAPI.models.orders.Address;
import com.amazon.SellingPartnerAPI.models.orders.AutomatedShippingSettings;
import com.amazon.SellingPartnerAPI.models.orders.BuyerInfo;
import com.amazon.SellingPartnerAPI.models.orders.BuyerTaxInformation;
import com.amazon.SellingPartnerAPI.models.orders.EasyShipShipmentStatus;
import com.amazon.SellingPartnerAPI.models.orders.ElectronicInvoiceStatus;
import com.amazon.SellingPartnerAPI.models.orders.FulfillmentInstruction;
import com.amazon.SellingPartnerAPI.models.orders.MarketplaceTaxInfo;
import com.amazon.SellingPartnerAPI.models.orders.Money;
import com.amazon.SellingPartnerAPI.models.orders.PaymentExecutionDetailItemList;
import com.amazon.SellingPartnerAPI.models.orders.PaymentMethodDetailItemList;
...
public class Order {
  ...
  **/
  @Schema(required = true, description = "The date when the order was last updated.  __Note__: `LastUpdateDate` is returned with an incorrect date for orders that were last updated before 2009-04-01.")
  ...
  **/
  @Schema(description = "The payment method for the order. This property is limited to COD and CVS payment methods. Unless you need the specific COD payment information provided by the `PaymentExecutionDetailItem` object, we recommend using the `PaymentMethodDetails` property to get payment method information.")
  ...
  **/
  @Schema(description = "The shipment service level category for the order.  **Possible values**: `Expedited`, `FreeEconomy`, `NextDay`, `Priority`, `SameDay`, `SecondDay`, `Scheduled`, and `Standard`.")
  ...
  **/
  @Schema(description = "The start of the time period within which you have committed to fulfill the order. In [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date time format. Only returned for seller-fulfilled orders.")
  ...
  **/
  @Schema(description = "The end of the time period within which you have committed to fulfill the order. In [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date time format. Only returned for seller-fulfilled orders that do not have a `PendingAvailability`, `Pending`, or `Canceled` status.")
  ...
  **/
  @Schema(description = "When true, the order has a Premium Shipping Service Level Agreement. For more information about Premium Shipping orders, refer to \"Premium Shipping Options\" in the Seller Central Help for your marketplace.")
  ...
  **/
  @Schema(description = "Indicates the date by which the seller must respond to the buyer with an estimated ship date. Only returned for Sourcing on Demand orders.")
  ...
  **/
  @Schema(description = "When true, the estimated ship date is set for the order. Only returned for Sourcing on Demand orders.")
  ...
  **/
  @Schema(description = "The buyer's invoicing preference. Sellers can use this data to issue electronic invoices for orders in Turkey.  **Note**: This attribute is only available in the Turkey marketplace.")
  ...
  **/
  @Schema(description = "The seller’s friendly name registered in the marketplace where the sale took place. Sellers can use this data to issue electronic invoices for orders in Brazil.  **Note**: This attribute is only available in the Brazil marketplace for the orders with `Pending` or `Unshipped` status.")
