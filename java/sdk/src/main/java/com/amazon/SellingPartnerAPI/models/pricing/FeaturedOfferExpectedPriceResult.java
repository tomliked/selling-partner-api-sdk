...
import com.amazon.SellingPartnerAPI.models.pricing.FeaturedOffer;
import com.amazon.SellingPartnerAPI.models.pricing.FeaturedOfferExpectedPrice;
...
public class FeaturedOfferExpectedPriceResult {
  ...
  **/
   ...
   * @return resultStatus
  **/
  @Schema(required = true, description = "The status of the FOEP computation. Possible values include `VALID_FOEP`, `NO_COMPETING_OFFER`, `OFFER_NOT_ELIGIBLE`, `OFFER_NOT_FOUND`, and `ASIN_NOT_ELIGIBLE`. Additional values might be added in the future.")
