...
import com.amazon.SellingPartnerAPI.models.vendor.df.payments.Address;
...
public class TaxRegistrationDetail {
  ...
  **/
  @Schema(required = true, description = "Tax registration number for the entity. For example, VAT ID, Consumption Tax ID.")
