...
public void createScheduledPackageTest() throws ApiException, LWAException {
    CreateScheduledPackageRequest body = null;
ModelPackage response = api.createScheduledPackage(body);
...
public void createScheduledPackageBulkTest() throws ApiException, LWAException {
    CreateScheduledPackagesRequest body = null;
CreateScheduledPackagesResponse response = api.createScheduledPackageBulk(body);
...
public void listHandoverSlotsTest() throws ApiException, LWAException {
    ListHandoverSlotsRequest body = null;
ListHandoverSlotsResponse response = api.listHandoverSlots(body);
...
public void updateScheduledPackagesTest() throws ApiException, LWAException {
    UpdateScheduledPackagesRequest body = null;
Packages response = api.updateScheduledPackages(body);
