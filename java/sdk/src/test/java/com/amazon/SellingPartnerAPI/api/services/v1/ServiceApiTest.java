...
public class ServiceApiTest extends ApiTest {
...
private final ServiceApi api = new ServiceApi.Builder()
    ...
    public void addAppointmentForServiceJobByServiceJobIdTest() throws Exception {
        ...
        AddAppointmentRequest body = new AddAppointmentRequest();String serviceJobId = "";
    ...
    public void assignAppointmentResourcesTest() throws Exception {
        ...
        AssignAppointmentResourcesRequest body = new AssignAppointmentResourcesRequest();String serviceJobId = "";String appointmentId = "";
    ...
    public void createReservationTest() throws Exception {
        ...
        CreateReservationRequest body = new CreateReservationRequest();List<String> marketplaceIds = new ArrayList<>();
    ...
    public void getFixedSlotCapacityTest() throws Exception {
        ...
        FixedSlotCapacityQuery body = new FixedSlotCapacityQuery();String resourceId = "";List<String> marketplaceIds = new ArrayList<>();
    ...
    public void getRangeSlotCapacityTest() throws Exception {
        ...
        RangeSlotCapacityQuery body = new RangeSlotCapacityQuery();String resourceId = "";List<String> marketplaceIds = new ArrayList<>();
    ...
    public void rescheduleAppointmentForServiceJobByServiceJobIdTest() throws Exception {
        ...
        RescheduleAppointmentRequest body = new RescheduleAppointmentRequest();String serviceJobId = "";String appointmentId = "";
    ...
    public void setAppointmentFulfillmentDataTest() throws Exception {
        ...
        SetAppointmentFulfillmentDataRequest body = new SetAppointmentFulfillmentDataRequest();String serviceJobId = "";String appointmentId = "";
    ...
    public void updateReservationTest() throws Exception {
        ...
        UpdateReservationRequest body = new UpdateReservationRequest();String reservationId = "";List<String> marketplaceIds = new ArrayList<>();
    ...
    public void updateScheduleTest() throws Exception {
        ...
        UpdateScheduleRequest body = new UpdateScheduleRequest();String resourceId = "";List<String> marketplaceIds = new ArrayList<>();
