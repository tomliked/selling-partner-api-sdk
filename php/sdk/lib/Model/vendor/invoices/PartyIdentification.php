...
class PartyIdentification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             'party_id' => 'string',
             'address' => '\OpenAPI\Client\Model\vendor\invoices\Address',
             'tax_registration_details' => '\OpenAPI\Client\Model\vendor\invoices\TaxRegistrationDetails[]'    ];
    ...
    */
     ...
     * Gets address
     *
     * @return \OpenAPI\Client\Model\vendor\invoices\Address|null
     */
    public function getAddress(): ?\OpenAPI\Client\Model\vendor\invoices\Address
    {
     ...
     * Sets address
     *
     * @param \OpenAPI\Client\Model\vendor\invoices\Address|null $address address
     *
     * @return self
     */
    public function setAddress(?\OpenAPI\Client\Model\vendor\invoices\Address $address): self
    {
        if (is_null($address)) {
