...
class PartyIdentification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPITypes = [
             'party_id' => 'string',
             'address' => '\OpenAPI\Client\Model\vendor\df\payments\v1\Address',
             'tax_registration_details' => '\OpenAPI\Client\Model\vendor\df\payments\v1\TaxRegistrationDetail[]'    ];
    ...
    */
     ...
     */
    public function getAddress(): ?\OpenAPI\Client\Model\vendor\df\payments\v1\Address
    {
     ...
     * Sets address
     *
     * @param \OpenAPI\Client\Model\vendor\df\payments\v1\Address|null $address address
     *
     * @return self
     */
    public function setAddress(?\OpenAPI\Client\Model\vendor\df\payments\v1\Address $address): self
    {
        if (is_null($address)) {
