...
class FbaInboundApi
{
     ...
     * @return \OpenAPI\Client\Model\fbaInbound\GetItemEligibilityPreviewResponse
     */
    public function getItemEligibilityPreview(
        string $asin,
        string $program,
        ?array $marketplace_ids = null
    ): \OpenAPI\Client\Model\fbaInbound\GetItemEligibilityPreviewResponse {
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\fbaInbound\GetItemEligibilityPreviewResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getItemEligibilityPreviewWithHttpInfo(
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\fbaInbound\GetItemEligibilityPreviewResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\fbaInbound\GetItemEligibilityPreviewResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\fbaInbound\GetItemEligibilityPreviewResponse', []),
            ...
            $returnType = '\OpenAPI\Client\Model\fbaInbound\GetItemEligibilityPreviewResponse';
